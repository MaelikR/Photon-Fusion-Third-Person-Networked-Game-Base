namespace Fusion
{
    ...
    public class FusionBootstrapDebugGUI : Fusion.Behaviour
    {
        ...
        private void Update()
        {
            ...
            //Debug.Log("Current Stage: " + currentstage); // Add this line for debugging
        ...
        protected void Start()
        {
            ...
            var existingPlayer = FindObjectOfType<ThirdPersonController>();
        ...
        protected virtual void OnGUI()
        {
            ...
            // Adjust the area width and height
            ...
            // Use GUI.depth to handle overlapping (lower depth renders on top)
            //GUI.depth = 0;
            ...
            GUILayout.BeginArea(new Rect(centerX, centerY, areaWidth, areaHeight), GUI.skin.box);
            {
                ...
                {
                    if (currentstage == FusionBootstrap.Stage.Disconnected && !showOptionsMenu && !showCreditsMenu)
                    {
